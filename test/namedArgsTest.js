...
describe('Function', function() {
  ...
  it('adds "withArgs" and "applyNamed" to the Function prototype', function() {
    expect(Function.prototype.applyNamed).to.be.a(Function);
    expect(Function.prototype.withArgs).to.be.a(Function);
  });
